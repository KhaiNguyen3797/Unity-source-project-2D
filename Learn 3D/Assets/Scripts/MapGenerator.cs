...
public class MapGenerator : MonoBehaviour
{
    ...
    public void GenerateMap()
    {
        ...
        shuffledTileCoords = new Queue<Coord>(Utility.ShuffleArray(allTileCoord.ToArray(), seed));
        ...
        for(int i = 0; i < obstacleCount; i++)
        {
            ...
            Transform newObstacle = Instantiate(obstaclePrefabs, obstaclePosition + Vector3.up * .5f, Quaternion.identity) as Transform;
